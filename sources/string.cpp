...
/* front */
auto cs::string::front(void) noexcept -> reference {
	return *_data;
}

/* front */
auto cs::string::front(void) const noexcept -> const_reference {
	return *_data;
}

/* back */
auto cs::string::back(void) noexcept -> reference {
	return *(_data + _size - 1U);
}

/* back */
auto cs::string::back(void) const noexcept -> const_reference {
	return *(_data + _size - 1U);
}
...
/* erase */
auto cs::string::erase(const size_type pos) noexcept -> void {
	...
	// shift data
	cs::memmove(_data + pos, _data + pos + 1U, _size - pos);
...
auto cs::string::_append_multi(size_type& ___of, const value_type ___ch) -> size_type {
...
/* append multi (string) */
auto cs::string::_append_multi(size_type& ___of, const ___self& ___ot) -> size_type {
...
auto cs::string::_append_multi(size_type& ___of, const cs::string_view& ___ot) -> size_type {
...
auto cs::string::_reserve(size_type ___cp) -> void {
	...
	_data != _empty
		? ___ptr = ___self::_reallocate(___cp)
		: ___ptr = ___self::_allocate(___cp);
